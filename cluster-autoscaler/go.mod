...
require (
	...
	k8s.io/api v0.17.17
	k8s.io/apimachinery v0.17.18-rc.0.0.20210518100625-c73b80db6ee8
...
replace (
	...
	k8s.io/apimachinery => k8s.io/apimachinery v0.17.18-rc.0.0.20210518100625-c73b80db6ee8
...
replace k8s.io/kubernetes => k8s.io/kubernetes v1.17.17
